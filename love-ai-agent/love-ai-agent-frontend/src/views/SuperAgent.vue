...
// 设置页面标题和元数据
useHead({
  title: 'AI恋爱超级智能体 - AI超级智能体应用平台',
  meta: [
    {
      name: 'description',
      content: 'AI恋爱超级智能体是全能助手, 能解答各类专业问题, 提供精准建议和解决方案'
    },
    {
      name: 'keywords',
      content: 'AI超级恋爱智能体, 智能助手, 专业问答, AI问答, 专业建议, AI智能体'
    }
  ]
})
...
onMounted(() => {
  // 添加欢迎消息
  addMessage('你好, 我是AI恋爱超级智能体。我可以解答各类问题, 提供专业建议, 请问有什么可以帮助你的吗？', false)
})
